...
JOptionPane.showMessageDialog(null,"Complete Drug Information","Missing Information",2);
   ...
   if(check_expiry()){ // if drug is expired it will not be execute
       String sql = "update drugs set PRODUCTION_DATE='"+pro_day.getSelectedItem()+"-"
+pro_month.getSelectedItem()+"-"+pro_year.getSelectedItem()+"' , EXPIRATION_DATE='"
+exp_day.getSelectedItem()+"-"+exp_month.getSelectedItem()+"-"+exp_year.getSelectedItem()
+"' ,EXPIRATION_TIME='"+exp_time.getText()+"' ,EXPIRY='Available for use' where BARCODE='"+barcode.getText()+"' ";
       try{
       pre=con.prepareStatement(sql);
       pre.execute();
